...
!!! note "Day 1 task"
    Write 2–3 simple team norms and one decision rule. Keep this short. Day 1 has only about 30 minutes of actual team work time, so the goal is alignment, not perfection.
