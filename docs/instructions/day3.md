...
- For each insight, fill in:
  ...
  - **Evidence / artifact:** Link to a figure, notebook, PDF, dashboard, data product, or raw output.
...
- Add 2-3 bullets under **Surprises, failures, and limitations**. It is useful to say what did not work.
...
- [ ] Reusable outputs linked where possible.
