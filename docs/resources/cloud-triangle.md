...
Project groups usually move between three connected places during the Summit:

- **GitHub**, where the team keeps the website, Markdown notes, scripts, notebooks, small figures, and public-facing project narrative.
- **Persistent storage**, where the team keeps raw data, large outputs, intermediate files, rasters, tables, and shared data products.
- **JupyterLab or another compute instance**, where the team does active analysis, exploration, temporary processing, and interactive work.
...
| Item | Best home | Why |
| --- | --- | --- |
| Team notes | GitHub | Small, readable, and versioned |
...
| Shared tables or data products | Persistent storage | Need to be findable by the team |
...
If another participant needs to understand what the team did during the Summit, GitHub should give them the trail.
...
JupyterLab, CyVerse VICE, or another compute instance is the place to work interactively. It is where participants open notebooks, test workflows, make plots, and inspect data.
